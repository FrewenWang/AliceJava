...
public class TreeMapDemo {
    ...
    private static void testNavigableMapAPIs() {
        ...
        System.out.printf("\n ---- testNavigableMapAPIs ----\n");
        // 打印出TreeMap
        System.out.printf("Whole list:%s%n", navMap);

        // 获取第一个key、第一个Entry
        System.out.printf("First key: %s\tFirst entry: %s%n", navMap.firstKey(), navMap.firstEntry());

        // 获取最后一个key、最后一个Entry
        System.out.printf("Last key: %s\tLast entry: %s%n", navMap.lastKey(), navMap.lastEntry());

        // 获取“小于/等于bbb”的最大键值对
        System.out.printf("Key floor before bbb: %s%n", navMap.floorKey("bbb"));

        // 获取“小于bbb”的最大键值对
        System.out.printf("Key lower before bbb: %s%n", navMap.lowerKey("bbb"));

        // 获取“大于/等于bbb”的最小键值对
        System.out.printf("Key ceiling after ccc: %s%n", navMap.ceilingKey("ccc"));

        // 获取“大于bbb”的最小键值对
        System.out.printf("Key higher after ccc: %s%n\n", navMap.higherKey("ccc"));
    ...
    private static void testTreeMapOridinaryAPIs() {
        ...
        Random r = new Random();
        //新建TreeMap
        Map<String, Integer> tmap = new MyTreeMap<>();
        ...
        System.out.printf("\n ---- testTreeMapOridinaryAPIs ----\n");
        // 打印出TreeMap。因为TreeMap是使用红黑树来存储的。是有序的。所以可以按照顺序打印出来
        System.out.printf("%s\n", tmap);
